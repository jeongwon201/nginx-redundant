...
### 요청
크롬을 이용하여 이중화된 서버에 요청을 보냅니다.   
<br />

요청을 보내기 전에 포트 포워딩을 통해 가상 머신에 접근할 수 있도록 해야합니다.   
<br />

앞서 CentOS 7을 설치하는 링크에서 포트 포워딩 작업을 수행했습니다.   
가상 머신의 컨테이너에 접근할 수 있도록 포트 포워딩하는 과정은 위 링크에서 수행한 과정과 동일합니다.
<br />

NatNetwork에 다음과 같이 포트 포워딩 조건을 추가합니다.
- 이름　　　프로토콜　호스트 IP　　호스트 포트 　　게스트 IP　　　게스트 포트   
- web　　 　　tcp　　　127.0.0.1　　　107　　　　10.100.0.105  　　　　80   
<br />
<br />
